...
![Alt Image Text](../images/chap7_11_2.png "body image")
...
另外需要注意在上面的 Ingress 中我们添加了一个 `nginx.ingress.kubernetes.io/service-upstream: true` 的注解，这是用来告诉 `Nginx Ingress Controller` 将流量路由到网格应用的服务，而不是直接路由到 Pod。
